...
import {
  ...
  ShoeAuthenticationTransactionService
} from "business";
...
ObjectFactory.register<IShoeAuthenticationTransactionService>(FactoryKeys.IShoeAuthenticationTransactionService, new ShoeAuthenticationTransactionService());
