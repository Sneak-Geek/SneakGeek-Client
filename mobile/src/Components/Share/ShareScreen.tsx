...
import { TouchableOpacity, View, StyleSheet, ScrollView, SafeAreaView, Text, Image } from 'react-native';
import {
  StackActions,
...
export class ShareScreen extends React.Component<IShareScreenScreenProps, IShareScreenScreenState> {
