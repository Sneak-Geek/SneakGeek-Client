  ...
  private renderGender() {
    ...
    return (
      <View style={styles.genderContainer}>
        <TouchableOpacity
          style={[styles.genderTouch, { marginRight: 37, borderBottomColor: gender === 'male' ? 'black' : 'white' }]}
          onPress={() => this.setState({ gender: 'male' })}
        >
          <Text style={[styles.gender, { opacity: gender === 'male' ? 1 : 0.3 }]}>NAM</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.genderTouch, { borderBottomColor: gender === 'female' ? 'black' : 'white' }]}
          onPress={() => this.setState({ gender: 'female' })}>
          <Text style={[styles.gender, { opacity: gender === 'female' ? 1 : 0.3 }]}>NỮ</Text>
        </TouchableOpacity>
      </View>
    )
  }
