            ...
            <View style={styles.stepContainer}>
                    ...
                    <View style={{ alignItems: 'center', marginRight: step === 1 ? 13 : 22 }}>
                        ...
                        {step > 1 ?
                            ...
                            <View style={{ marginVertical: 10 }}>
                                <Dash dashGap={3} dashLength ={8} dashThickness ={2} style={[styles.dash, { height: 25 }]} dashColor={Assets.Styles.AppPrimaryColor} />
                                <Dash dashGap={3} dashLength ={8} dashThickness ={2} style={[styles.dash, { height: 25 }]} dashColor='#C4C4C4' />
                            </View>
                        }
                    </View>
                    <View>
                ...
                <View style={{ flexDirection: 'row', paddingLeft: step === 2 ? 31 : 40 }}>
                    <View style={{ alignItems: 'center', marginRight: step === 2 ? 13 : 22 }}>
                        ...
                        {step < 2 &&
                            <Dash dashGap={3} dashLength ={8} dashThickness ={2} style={[styles.dash, { marginVertical: 10 }]} dashColor='#C4C4C4' />
                        }
                        {step === 2 &&
                            <View style={{ marginVertical: 10 }}>
                                <Dash dashGap={3} dashLength ={8} dashThickness ={2}  style={[styles.dash, { height: 25 }]} dashColor={Assets.Styles.AppPrimaryColor} />
