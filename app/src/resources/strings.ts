export const strings = {
  ...
  ForgotPasswordStep1: 'Để khôi phục lại mật khẩu, bạn cần điền địa chỉ email của tài khoản đăng nhập:',
  ForgotPasswordStep2a: 'Email chứa mã code để đặt lại mật khẩu đã được gửi đến hòm thư của bạn.',
  ForgotPasswordStep2b: 'Nhập mã code trong email của bạn vào đây:',
  ForgotPasswordStep3: 'Điền mật khẩu mới cho tài khoản của bạn:',
