...
export const LoadingIndicatorReducers = handleActionsWithReset<ILoadingIndicatorState, any>({
  [`${toggleIndicator}`]: (state: ILoadingIndicatorState, action: Action<IndicatorPayload>) => ({
