...
var OrderService = /** @class */ (function (_super) {
    ...
    OrderService.prototype.createSellOrder = function (token, sellOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiClient.getInstance().post("/order/sell-order/new", {
                            shoeId: sellOrder.shoeId,
                            shoeSize: sellOrder.shoeSize,
                            sellNowPrice: sellOrder.sellNowPrice,
