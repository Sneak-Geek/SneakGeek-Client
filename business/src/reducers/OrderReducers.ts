...
export const OrderReducers = handleActions<IOrderState, any>({
  [`${buyShoe}`]: (state: IOrderState, action: Action<{ shoe?: Shoe, size?: string }>) => ({
    ...state,
    buyState: {
      ...state.buyState,
  ...
  [`${updateGetSellOrdersState}`]: (state: IOrderState, action: Action<GetSellOrdersPayload>) => ({
    ...state,
    sellOrdersState: {
  ...
  [`${updateGetBuyOrdersState}`]: (state: IOrderState, action: Action<GetBuyOrdersPayload>) => ({
    ...state,
    buyOrdersState: {
