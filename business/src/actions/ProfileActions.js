...
exports.updateStateGetUserProfile = redux_actions_1.createAction(exports.ProfileActions.UPDATE_STATE_GET_USER_PROFILE);
exports.updateProfile = redux_actions_1.createAction(exports.ProfileActions.SET_PROFILE);
exports.getUserProfile = function () {
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        var accountService, settings, token, profile, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dispatch(exports.updateStateGetUserProfile({ state: payload_1.NetworkRequestState.REQUESTING }));
                    token = settings.getValue(interfaces_1.SettingsKey.CurrentAccessToken);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, accountService.getUserProfile(token)];
                case 2:
                    profile = _a.sent();
                    if (profile) {
                        dispatch(exports.updateStateGetUserProfile({
                ...
                case 3:
                    error_1 = _a.sent();
                    exports.updateStateGetUserProfile({ state: payload_1.NetworkRequestState.FAILED, error: error_1 });
                    return [3 /*break*/, 4];
